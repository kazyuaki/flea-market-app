...
<main>
    <div class="mypage-edit">
        ...
        <form action="{{ route('profile.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="form-group__label" for="zipcode">郵便番号</label>
                <input class="form-group__input" type="text" id="zipcode" name="zipcode" value="{{ old('zipcode') }}">
                @error('zipcode')
                <div class="form-group__error">{{ $message }}</div>
                @enderror
            </div>
            <div class="form-group">
                ...
                <input class="form-group__input" type="text" id="address" name="address" value="{{ old('address') }}">
                @error('address')
                <div class="form-group__error">{{ $message }}</div>
                @enderror
            </div>
            <div class="form-group">
                ...
                <input class="form-group__input" type="text" id="building_name" name="building_name" value="{{ old('building_name') }}">
                @error('building')
                <div class="form-group__error">{{ $message }}</div>
                @enderror
            </div>
